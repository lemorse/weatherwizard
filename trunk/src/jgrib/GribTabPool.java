...
//
//	   
//	   // add default, ncep  1-3
//	   tableList.add(new GribTab(7, 1, default_paramtable));
//       tableList.add(new GribTab(7, 2, default_paramtable));
//       tableList.add(new GribTab(7, 3, default_paramtable));
//
//       // Add default, ecmwf 3
//       tableList.add(new GribTab(81, 3, default_paramtable));
//
//       loadTables();
//       sorted = false;
//   }
...
//   /**
//    * Load all tables from  jar file (class path)
//    */
//   private static void loadTables()
//   {
//      ClassLoader cl = GribTabPool.class.getClassLoader();
//      URL url = cl.getResource(TABLE_DIRECTORY + "/" + TABLE_LIST);
//      if (url == null) return;
//      try
//      {
...
//         {
//            //System.out.println("grib tab: " + tableName);
//            url = cl.getResource(TABLE_DIRECTORY + "/" + tableName);
//            if (url != null) addParamterTable(url);
//         }
//      }
//      catch (IOException e)
//      {
...
//    * @param aGribTab
//    */
//   private static void addTable(GribTab aGribTab)
//   {
//      if (tableList.contains(aGribTab))
//      {
//         System.out.println("Table with table_id: "+aGribTab.getTableId()+" and centre_id: "+aGribTab.getCenterId()+
//               " already loaded, table replaced");
//      }
//      tableList.add(aGribTab);
//      sorted = false;
//   }
...
//    * 
//    * @param ix
//    * @return - a deprecated class: GribTab
//    */
//   private static GribTab tab(int ix)
//   {
//      return (GribTab) tableList.get(ix);
//   }
//
//   /**
//    * Look up correct grib table
//    * First compare table id and center id. If no match, try only table id
//    *
//    * @param center center id
//    * @param table  table id
//    * @return  grib table
//    */
//   public static GribTab lookup(int center, int table)
//   {
//      /* Occurs often:
//      center 88 subcenter 0 process 200 Table 2
//      center 88 subcenter 0 process 230 Table 2
//      center 88 subcenter 0 process 255 Table 2
//      center 98 subcenter 0 process 113 Table 3
//      center 98 subcenter 0 process 201 Table 128
//      center 98 subcenter 0 process 201 Table 3
//      */
//
//      GribTab gt = new GribTab(center, table, null);
//      if (!sorted)
//      {
//         Collections.sort(tableList);
//         sorted = true;
//      }
//      int ix = Collections.binarySearch(tableList, gt);
//      if (ix >= 0)
//      {
//         return tab(ix);
//         //equal (table:match, center: match)
//      }
//      //excact match not found; find first with same table id
//      //int sz = tableList.size();
//      ix = -ix - 1;
//      int i0 = Math.max(ix - 1, 0);
//      int i1 = Math.min(ix + 1, tableList.size() - 1);
//      for (int i = i0; i <= i1; ++i)
//      {
//	    if (gt.getTableId() == tab(i).getTableId())
//	       return tab(i);
//      }
//      return null;
//   }
