  ...
  extends JPanel
{
  ...
  public void setWidth(int width) { widthValueLabel.setText(Integer.toString(width)); }
  public void setHeight(int height) { heightValueLabel.setText(Integer.toString(height)); }
  public void setStepX(double d) { stepXValueLabel.setText(Double.toString(d)); }
  public void setStepY(double d) { stepYValueLabel.setText(Double.toString(d)); }
  public void setTop(double d){ topValueLabel.setText(GeomUtil.decToSex(d, GeomUtil.SWING, GeomUtil.NS)); }
  public void setBottom(double d){ bottomValueLabel.setText(GeomUtil.decToSex(d, GeomUtil.SWING, GeomUtil.NS)); }
  public void setLeft(double d){ leftValueLabel.setText(GeomUtil.decToSex(d, GeomUtil.SWING, GeomUtil.EW)); }
  public void setRight(double d){ rightValueLabel.setText(GeomUtil.decToSex(d, GeomUtil.SWING, GeomUtil.EW)); }
}
