...
//                 (int)(rect.height / imgRatio));
  ...
  private final void refreshThumbnail(boolean force) throws Exception
  {
    if (force || (!force && System.currentTimeMillis() - lastRefresh > 1000L)) // No more than once every second
    {
