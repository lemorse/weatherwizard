     ...
     extends PlacesTableMap 
{
  ...
  {
    if (indexes.length != dataModel.getRowCount()) 
    {
  ...
  {
    checkModel();
    return (dataModel==null)?null:dataModel.getValueAt(indexes[aRow], aColumn);
  }

  public void setValueAt(Object aValue, int aRow, int aColumn) 
  {
    checkModel();
    dataModel.setValueAt(aValue, indexes[aRow], aColumn);
  }
