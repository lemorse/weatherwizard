  ...
  extends JPanel
{
  ...
  private JTextField hintTextField = new JTextField();
...
//  }  
  ...
  public void setTWS3D(boolean b) { tws3DCheckBox.setSelected(b); }
  public void setPRMSL3D(boolean b) { prmsl3DCheckBox.setSelected(b); }
  public void set500MB3D(boolean b) { mb5003DCheckBox.setSelected(b); }
  public void setWAVES3D(boolean b) { waves3DCheckBox.setSelected(b); }
  public void setTEMP3D(boolean b) { temperature3DCheckBox.setSelected(b); }
  public void setPRATE3D(boolean b) { prate3DCheckBox.setSelected(b); }
  
  public void setTWSContour(boolean b) { contourTWSCheckBox.setSelected(b); }
  public void setPRMSLContour(boolean b) { contourPRMSLCheckBox.setSelected(b); }
  public void set500MBContour(boolean b) { contourMB500CheckBox.setSelected(b); }
  public void setWAVESContour(boolean b) { contourWavesCheckBox.setSelected(b); }
  ...
  public boolean getTEMPData() { return temperatureDataCheckBox.isSelected(); }
  public boolean getPRATEData() { return prateDataCheckBox.isSelected(); }
  
  public boolean getTWS3D() { return tws3DCheckBox.isSelected() && tws3DCheckBox.isEnabled(); }
  public boolean getPRMSL3D() { return prmsl3DCheckBox.isSelected() && prmsl3DCheckBox.isEnabled(); }
  public boolean get500MB3D() { return mb5003DCheckBox.isSelected() && mb5003DCheckBox.isEnabled(); }
  public boolean getWAVES3D() { return waves3DCheckBox.isSelected() && waves3DCheckBox.isEnabled(); }
  public boolean getTEMP3D() { return temperature3DCheckBox.isSelected() && temperature3DCheckBox.isEnabled(); }
  public boolean getPRATE3D() { return prate3DCheckBox.isSelected() && prate3DCheckBox.isEnabled(); }
  
  public boolean getTWSContour() { return contourTWSCheckBox.isSelected() && contourTWSCheckBox.isEnabled(); }
  public boolean getPRMSLContour() { return contourPRMSLCheckBox.isSelected() && contourPRMSLCheckBox.isEnabled(); }
  public boolean get500MBContour() { return contourMB500CheckBox.isSelected() && contourMB500CheckBox.isEnabled(); }
  public boolean getWAVESContour() { return contourWavesCheckBox.isSelected() && contourWavesCheckBox.isEnabled(); }
  public boolean getTEMPContour() { return contourTemperatureCheckBox.isSelected() && contourTemperatureCheckBox.isEnabled(); }
  public boolean getPRATEContour() { return contourPrateCheckBox.isSelected() && contourPrateCheckBox.isEnabled(); }
    
  public void setHint(String s) { hintTextField.setText(s); }
  public void setRequest(String s) { requestTextField.setText(s); }
  public void setDir(ParamPanel.DataDirectory d) { directoryTextField.setText(d.toString()); }
  public void setPrefix(String s) { prefixTextField.setText(s); }
  public void setPattern(String s) { patternTextField.setText(s); }
  public void setExtension(String s) { extensionTextField.setText(s); }

//public boolean getJustWind() { return justWindCheckBox.isSelected(); }
  public String getHint() { return hintTextField.getText(); }
  public String getRequest() { return requestTextField.getText(); }
  public ParamPanel.DataDirectory getDir() { return new ParamPanel.DataDirectory("GRIBs", 
