...
//      thisOne.getChildrenByTagName("label").item(0).getFirstChild().setNodeValue(label);
        ...
        try { thisOne.getChildrenByTagName("comment").item(0).removeChild(thisOne.getChildrenByTagName("comment").item(0).getFirstChild()); } catch (Exception exe) { exe.printStackTrace(); }
