package chartview.gui.right.matrix;
...
{
  double thetaX = 0d, thetaY = 0d, thetaZ = 0d;
  ...
  {
    thetaY += theta;
//  System.out.println("yRot:" + thetaY);
  ...
  {
    thetaX += theta;
//  System.out.println("xRot:" + thetaX);
    theta = Math.toRadians(theta);
    double ct = Math.cos(theta);
    double st = Math.sin(theta);
  ...
  {
    thetaZ += theta;
//  System.out.println("zRot:" + thetaZ);
    theta = Math.toRadians(theta);
    double ct = Math.cos(theta);
    double st = Math.sin(theta);
