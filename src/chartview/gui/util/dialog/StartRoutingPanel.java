     ...
     extends JPanel
{
  ...
  {
    try { timeInterval = Integer.parseInt(timeIntervalTextField.getText()); } catch (Exception ignore) {}
    return timeInterval;
  }
  ...
  {
    try { angularStep = Integer.parseInt(angularStepTextField.getText()); } catch (Exception ignore) {}
    return angularStep;
  }
  ...
  {
    try { forkWidth = Integer.parseInt(forkWidthTextField.getText()); } catch (Exception ignore) {}
    return forkWidth;
  }
  ...
  {
    try { maxTWS = Integer.parseInt(maxTWSTextField.getText()); } catch (Exception ignore) {}
    return maxTWS;
  }
  ...
  {
    try { minTWA = Integer.parseInt(minTWATextField.getText()); } catch (Exception ignore) {}
    return minTWA;
  }
