     ...
     extends JPanel
{
  ...
  private GribRequestPopup menuPopup = new GribRequestPopup(this);
  ...
  private JSlider periodSlider = new JSlider();
  private JTextField bottomTextField = new JTextField();
  private JTextField topTextField = new JTextField();
  private JTextField leftTextField = new JTextField();
  ...
  private JRadioButton twoRadioButton = new JRadioButton();
  private JRadioButton fourRadioButton = new JRadioButton();
    ...
    sixRadioButton.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
            sixRadioButton_actionPerformed(e);
          }
        });
    ...
    twelveRadioButton.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
            twelveRadioButton_actionPerformed(e);
          }
        });
    twentyfourRadioButton.setText(WWGnlUtilities.buildMessage("24-hours"));
    twentyfourRadioButton.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
    ...
    fourRadioButton.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
            fourRadioButton_actionPerformed(e);
          }
        });
      ...
      switch (tokenIndex)
      {
        ...
        case 2: // Period
          ...
          else
          {
            ...
            int len = 72;
            try { len = Integer.parseInt(lenStr); } catch (Exception ignore) {}
...
//          System.out.println("Data Token:" + s);
            if (s.equals("PRMSL"))
              ...
              windCheckBox.setSelected(true);
            else if (s.equals("HGT500") || s.equals("HGT"))
              hgt500CheckBox.setSelected(true);
            else if (s.equals("TEMP") || s.equals("SEATMP") || s.equals("AIRTEMP"))
              tempCheckBox.setSelected(true);
            else if (s.equals("WAVES"))
...
//  System.out.println("Focus lost");
    try { parseGRIBRequest(requestField.getText()); }
    catch (Exception ex) { System.out.println(ex.getMessage()); }
